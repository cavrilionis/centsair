...
ui <- fluidPage(
  ...
  tags$nav(
    ...
    tags$a(class = "navbar-brand col-sm-3 col-md-2 mr-0", href = "#", "Company name"),
    tags$input(type = "text", class = "form-control form-control-dark w-100", placeholder = "Search"),
    tags$ul(
      class = "navbar-nav px-3",
      tags$li(class = "nav-item text-nowrap",
              tags$a(class = "nav-link", href = "#", "Sign out"))
    )
  ),
        ...
        div(
          ...
          div(
            ...
            div(
              ...
              tags$button(type = "button", class = "btn btn-sm btn-outline-secondary", "Share"),
              tags$button(type = "button", class = "btn btn-sm btn-outline-secondary", "Export")
            ),
